<div class="col-md-6">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	    ...
	    elseif ( get_post_format() == 'link' && function_exists('rwmb_meta') && rwmb_meta('snssimen_post_linkurl') ) : ?>
	        <div class="link-info">
	            <a class="gfont" title="<?php echo esc_attr(rwmb_meta('snssimen_post_linktitle')) ?>" href="<?php echo esc_url( rwmb_meta('snssimen_post_linkurl') ) ?>"><?php echo esc_html(rwmb_meta('sns_post_linktitle')) ?></a>
	    ...
	    ?>
	        <div class="gallery-thumb">
	            ...
	            <?php
	            foreach (rwmb_meta('sns_post_gallery', 'type=image') as $image) {?>
	        ...
	        <div class="content">
	            ...
	            <?php if( snssimen_get_option('show_categories') == true || snssimen_get_option('show_tags') == true || snssimen_get_option('show_comment_count') == true || snssimen_get_option('show_view_count') == true ): ?>
		            <div class="post-meta">
		                ...
		                ?>
		            	<?php if( snssimen_get_option('show_categories' && get_the_category_list()) == true ): ?>
