	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	    ...
	    <div class="post-content">
	        ...
	        <div class="content">
	            ...
	            <?php if( snssimen_get_option('show_categories', true) == true || snssimen_get_option('show_tags', true) == true || snssimen_get_option('show_comment_count', true) == true || snssimen_get_option('show_view_count', true) == true ): ?>
		            <div class="post-meta">
		            	<?php
	                    // Is sticky or not
