...
?>
<div class="blog-grid-3 posts sns-blog-posts <?php echo esc_attr($wclass);?>">
	<div id="snsmain" class="row">
		<?php 
		while ( have_posts() ) : the_post();
		?>
			<?php get_template_part( 'framework/tpl/posts/post-grid3', get_post_format() )?>
		<?php
		endwhile;
		?>
	</div>
...
<?php
if( $pagination == 'ajax')
	snssimen_paging_nav_ajax('#snsmain', 'framework/tpl/posts/post-grid3' ); // This paging nav should be outside #snsmain div
