...
require SNSSIMEN_THEME_DIR . '/framework/sample-data/parsers.php';
...
<?php if ( ! empty( $this->authors ) ) : ?>
	...
	<p><?php echo wp_kses( __( 'To make it easier for you to edit and save the imported content, you may want to reassign the author of the imported item to an existing user of this site. For example, you may want to import all the entries as <code>admin</code>s entries.', 'wordpress-importer' ), array(
			'code' => array()
		) ); ?></p>
...
<?php endif; ?>
	...
	<p class="submit"><input type="submit" class="button" value="<?php esc_attresc_html_e( 'Submit', 'wordpress-importer' ); ?>" /></p>
</form>
<?php
	}
...
function wordpress_importer_init() {
	...
	register_importer( 'wordpress', 'WordPress', esc_html__('Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file.', 'wordpress-importer'), array( $GLOBALS['wp_import'], 'dispatch' ) );
}
